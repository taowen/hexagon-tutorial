/*
 * HVX f32 Matmul implementations (v75+) -- VTCM scratch variant
 *
 * Identical to ch08's hvx_matmul.h except g_scratch is a pointer
 * (set by skel_vtcm.c to a VTCM address) instead of a static BSS array.
 */
#ifndef HVX_MATMUL_VTCM_H
#define HVX_MATMUL_VTCM_H
