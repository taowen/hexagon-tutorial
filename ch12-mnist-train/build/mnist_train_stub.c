#ifndef _MNIST_TRAIN_STUB_H
#define _MNIST_TRAIN_STUB_H
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(mnist_train_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(mnist_train_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_close)(h);
}
static __inline int _stub_method(remote_handle64 _handle, uint32_t _mid, uint64_t _in0[1]) {
   remote_arg _pra[1] = {0};
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(mnist_train_start)(remote_handle64 _handle, uint64 dsp_queue_id) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
   return _stub_method(_handle, _mid, (uint64_t*)&dsp_queue_id);
}
static __inline int _stub_method_1(remote_handle64 _handle, uint32_t _mid, uint64_t _rout0[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[1] = {0};
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(mnist_train_stop)(remote_handle64 _handle, uint64* process_time) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method_1(_handle, _mid, (uint64_t*)process_time);
}
static __inline int _stub_method_2(remote_handle64 _handle, uint32_t _mid, char* _in0[1], uint32_t _in0Len[1], char* _in1[1], uint32_t _in1Len[1], char* _rout2[1], uint32_t _rout2Len[1], uint32_t _in3[1], uint32_t _in4[1], uint32_t _in5[1], uint32_t _in6[1], uint64_t _rout7[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[5] = {0};
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(mnist_train_do_matmul)(remote_handle64 _handle, const uint8* a_buf, int a_bufLen, const uint8* b_buf, int b_bufLen, uint8* c_buf, int c_bufLen, uint32 m, uint32 n, uint32 k, uint32 transpose, uint64* process_time) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 4;
   return _stub_method_2(_handle, _mid, (char**)&a_buf, (uint32_t*)&a_bufLen, (char**)&b_buf, (uint32_t*)&b_bufLen, (char**)&c_buf, (uint32_t*)&c_bufLen, (uint32_t*)&m, (uint32_t*)&n, (uint32_t*)&k, (uint32_t*)&transpose, (uint64_t*)process_time);
}
#ifdef __cplusplus
}
#endif
#endif //_MNIST_TRAIN_STUB_H
