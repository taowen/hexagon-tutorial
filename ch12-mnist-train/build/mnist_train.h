#ifndef _MNIST_TRAIN_H
#define _MNIST_TRAIN_H
#include <AEEStdDef.h>
#include <remote.h>
#include <string.h>
#include <stdlib.h>
...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(mnist_train_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(mnist_train_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(mnist_train_start)(remote_handle64 _h, uint64 dsp_queue_id) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(mnist_train_stop)(remote_handle64 _h, uint64* process_time) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(mnist_train_do_matmul)(remote_handle64 _h, const uint8* a_buf, int a_bufLen, const uint8* b_buf, int b_bufLen, uint8* c_buf, int c_bufLen, uint32 m, uint32 n, uint32 k, uint32 transpose, uint64* process_time) __QAIC_HEADER_ATTRIBUTE;
#ifndef mnist_train_URI
#define mnist_train_URI "file:///libmnist_train_skel.so?mnist_train_skel_handle_invoke&_modver=1.0"
#endif /*mnist_train_URI*/
#ifdef __cplusplus
}
#endif
#endif //_MNIST_TRAIN_H
