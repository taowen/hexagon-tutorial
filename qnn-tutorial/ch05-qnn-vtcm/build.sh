...
echo "=== Building ch07: QNN VTCM Experiment ==="
...
$ARM_CC -O2 -Wall -std=c11 \
    -I"$QNN_SDK/include/QNN" \
    -o "$SCRIPT_DIR/build/aarch64/qnn_vtcm_test" \
    "$SCRIPT_DIR/src/host/qnn_vtcm_test.c" \
    -ldl -lm

echo "  -> build/aarch64/qnn_vtcm_test"

echo ""
echo "=== Build complete ==="
echo "Next: bash ch07-qnn-vtcm/run_device.sh"
